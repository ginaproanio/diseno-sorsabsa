      ...
      <table className="w-full max-w-2xl border-collapse font-mono text-xs">
        ...
        <tbody>
          {filas.map((f) => {
            ...
            return (
              <tr key={f.label} className="border-t border-zinc-200">
                <td className="py-2 pr-4 text-zinc-800">
                  {f.label}
                  <div className="mt-1 flex items-center gap-1">
                    <span className="inline-block h-3 w-3 rounded-sm border border-zinc-300" style={{ background: f.a }} />
                    <span className="text-zinc-400">/</span>
                    <span className="inline-block h-3 w-3 rounded-sm border border-zinc-300" style={{ background: f.b }} />
                  </div>
                </td>
                <td className="py-2 pr-4 text-zinc-600">{ratio.toFixed(2)}:1</td>
                <td className="py-2">
