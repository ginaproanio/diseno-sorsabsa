...
## Corpus Check
- 69 files · ~30,690 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 469 nodes · 702 edges · 25 communities (23 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5749c47a`
...
Cohesion: 0.11
Nodes (18): 1. Separar auth a su propio proyecto  🟠 #1 — INTENTADO 29-jul, chocó un muro real, 2. JustiRed al SSO central  🟡 casi hecho — faltan 3 pasos manuales, 3. ✅ HECHO — cutover de pagos (fuera de Vercel), 4-bis. Limpieza menor en agente24siete, 4. ✅ HECHO — notificaciones-sorsabsa → Railway, 5. RLS en tablas expuestas (seguridad), 6. Borrar proyecto Supabase huérfano, 7. SorsabsaForensic → Fase 0 antes de Railway (+10 more)
...
## Knowledge Gaps
- **203 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+198 more)
