# Graph Report - diseno-sorsabsa  (2026-08-26)

## Corpus Check
- 104 files · ~152,806 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1065 nodes · 1398 edges · 71 communities (67 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f85dc12`
...
### Community 0 - "costura.mjs"
Cohesion: 0.05
Nodes (45): AQUI, grafoAtrasado(), pedirGitHub(), tokenGitHub(), ultimoCommitDeCodigo(), aBarras(), cfg, descubrirLlamadas() (+37 more)
...
Cohesion: 0.11
Nodes (22): IconCatalog(), NAMES, SHADOW, FormSection(), FormSectionProps, InputProps, MobileNav(), MobileNavItem (+14 more)

### Community 9 - "Table.tsx"
Cohesion: 0.10
Nodes (24): DATA, TableDemo(), ALIGN, HIDE_CLASSES, hideClass(), ResponsiveBreakpoint, SIZE_CELL_PADDING, SIZE_HEADER_TEXT (+16 more)

### Community 10 - "index.ts"
Cohesion: 0.13
Nodes (16): Checkbox, CheckboxProps, ConfirmarAccion(), ConfirmarAccionProps, PropertyCarousel(), PropertyCarouselProps, SectionHeader(), SectionHeaderProps (+8 more)
...
### Community 14 - "BrandProvider.tsx"
Cohesion: 0.16
...
### Community 18 - "Auditoría — CondoManager como aplicación (más allá del portero)"
Cohesion: 0.09
...
Cohesion: 0.12
Nodes (16): AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials(), SIZE, ButtonProps, ButtonSize (+8 more)
...
### Community 23 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.11
...
### Community 25 - "CardStatusDemo.tsx"
Cohesion: 0.14
Nodes (13): CardStatusDemo(), SHADOW, TONES, Card(), CardContent(), CardDescription(), CardHeader(), CardHeaderProps (+5 more)
...
### Community 39 - "DomusLanding.tsx"
Cohesion: 0.22
Nodes (3): DomusLanding(), FEATURES, SOCIAL

### Community 40 - "4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026"
Cohesion: 0.25
...
### Community 53 - "31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026"
Cohesion: 0.40
...
### Community 57 - "9. Pendientes, en orden"
Cohesion: 0.50
Nodes (4): 9. Pendientes, en orden, Abiertos, en orden, Cerrados el 2026-07-30, Reglas que ya no dependen de la memoria

### Community 58 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
## Knowledge Gaps
- **593 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+588 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `Plan — una persona en más de un condominio (CondoManager)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`?**
...
- **Should `costura.mjs` be split into smaller, more focused modules?**
