...
## Corpus Check
- 71 files · ~47,132 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 521 nodes · 752 edges · 31 communities (28 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a5268a5c`
...
Cohesion: 0.05
Nodes (55): CardStatusDemo(), SHADOW, TONES, DATA, AppShell(), AppShellProps, Avatar(), AvatarProps (+47 more)
...
## Knowledge Gaps
- **247 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+242 more)
