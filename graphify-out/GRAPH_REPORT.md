...
## Corpus Check
- 92 files · ~123,299 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 880 nodes · 1153 edges · 56 communities (50 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18f29831`
...
Cohesion: 0.07
Nodes (32): DomusLanding(), FEATURES, SOCIAL, BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), brandToCssVars() (+24 more)
...
### Community 30 - "Grafo de conocimiento (graphify) generado por CI"
Cohesion: 0.20
...
### Community 38 - "2 · Método: dónde va cada cosa, y por qué"
Cohesion: 0.40
...
### Community 41 - "8 · Lo que la decisión de "no guardar" NO resuelve"
Cohesion: 0.50
...
## Knowledge Gaps
- **493 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+488 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `PENDIENTES-ECOSISTEMA.md`?**
