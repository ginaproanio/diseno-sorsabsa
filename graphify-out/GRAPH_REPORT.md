...
## Corpus Check
- 69 files · ~31,204 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 471 nodes · 704 edges · 25 communities (23 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fe37b3cd`
...
Cohesion: 0.07
Nodes (45): CardStatusDemo(), SHADOW, TONES, DATA, TableDemo(), Card(), CardContent(), CardHeader() (+37 more)
...
Cohesion: 0.11
Nodes (26): BRAND_FONT_IMPORTS, BrandColors, BrandConfig, BrandContext, BrandProvider(), brandToCssVars(), contrastRatio(), darkenToContrast() (+18 more)
...
Cohesion: 0.10
Nodes (18): DomusLanding(), FEATURES, SOCIAL, IconCatalog(), NAMES, SHADOW, Input, InputProps (+10 more)
...
### Community 7 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.08
...
### Community 11 - "showcase/package.json"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (20): 10. Login con Google (mejora, no bloquea nada)  🔵 apuntado 08-ago-2026, 11. agente24siete: /portal sin login real + cascarón viejo sin borrar  🟡 08-ago-2026, 1. Separar auth a su propio proyecto  🟠 #1 — INTENTADO 29-jul, chocó un muro real, 2. JustiRed al SSO central  🟡 casi hecho — faltan 3 pasos manuales, 3. ✅ HECHO — cutover de pagos (fuera de Vercel), 4-bis. Limpieza menor en agente24siete, 4. ✅ HECHO — notificaciones-sorsabsa → Railway, 5. RLS en tablas expuestas (seguridad) (+12 more)
...
## Knowledge Gaps
- **205 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+200 more)
