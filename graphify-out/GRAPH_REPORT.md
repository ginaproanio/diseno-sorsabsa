...
8. `Icon` - 9 edges
9. `Arquitectura del ecosistema SORSABSA` - 9 edges
...
## Knowledge Gaps
- **157 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+152 more)
