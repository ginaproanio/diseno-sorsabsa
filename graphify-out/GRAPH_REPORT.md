...
## Corpus Check
- 100 files · ~147,036 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1017 nodes · 1332 edges · 70 communities (66 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bb31ceb7`
...
### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (38): App(), BRAND_KEYS, AtomShowcase(), ColorPalette(), TOKEN_ORDER, ContrastReport(), FormDemo(), MOCK (+30 more)
...
Cohesion: 0.09
Nodes (31): BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), brandToCssVars(), contrastRatio(), darkenToContrast(), hexToRgb() (+23 more)
...
Cohesion: 0.12
Nodes (21): IconCatalog(), NAMES, SHADOW, FormSection(), FormSectionProps, Input, InputProps, MobileNav() (+13 more)
...
Cohesion: 0.14
Nodes (22): aBarras(), archivosDeRuta, cfg, descubrirLlamadas(), descubrirRutas(), entrada, esDir(), existe() (+14 more)
...
### Community 18 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.10
...
### Community 20 - "DomusLanding.tsx"
Cohesion: 0.10
Nodes (13): ButtonMatrix(), SHADOW, VARIANTS, DomusLanding(), FEATURES, SOCIAL, Button, ButtonProps (+5 more)
...
### Community 28 - "4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)"
Cohesion: 0.15
...
### Community 29 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.15
...
### Community 30 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
Cohesion: 0.22
Nodes (9): scripts, conformidad, conformidad:local, costura, costura:ecosistema, modales, modales:local, test (+1 more)
...
### Community 45 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 46 - "27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)"
Cohesion: 0.33
...
### Community 52 - "4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026"
Cohesion: 0.50
...
### Community 53 - "9. Pendientes, en orden"
Cohesion: 0.50
Nodes (4): 9. Pendientes, en orden, Abiertos, en orden, Cerrados el 2026-07-30, Reglas que ya no dependen de la memoria

### Community 55 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
### Community 60 - "exports"
Cohesion: 0.67
Nodes (3): exports, ./preset, ./tokens.css

## Knowledge Gaps
- **568 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+563 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `Plan — una persona en más de un condominio (CondoManager)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026`, `Plan — una persona en más de un condominio (CondoManager)`, `7. Decisión de arquitectura (2026-07-26)`, `3. Mapa de bases de datos — LA TRAMPA`, `2. Los dos planos`, `4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026`, `9. Pendientes, en orden`, `1. Inventario`, `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`?**
