...
## Corpus Check
- 89 files · ~110,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 805 nodes · 1081 edges · 47 communities (42 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a080629`
...
7. `Modelo de trabajo de JustiRed` - 13 edges
8. `Icon` - 12 edges
9. `Arquitectura del ecosistema SORSABSA` - 12 edges
10. `🔴 CRÍTICO` - 12 edges
...
### Community 10 - "Modelo de trabajo de JustiRed"
Cohesion: 0.06
Nodes (31): 10. Reglas de trabajo que salieron de los defectos, 1. Inventariar — ✅, 1. Las unidades de trabajo, 2. Adquirir — ✅ separado el 17-ago-2026, 2. Clasificaciones que importan, 3. Cómo clasifican las empresas del sector, 3. Extraer — ⚠️ convierte bien y tira el texto, 4. El inventario (+23 more)
...
### Community 18 - "IconName"
Cohesion: 0.20
Nodes (12): FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, InputProps, MobileNav(), MobileNavItem, MobileNavProps (+4 more)
...
### Community 22 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
### Community 24 - "NotificationBell.tsx"
Cohesion: 0.21
...
## Knowledge Gaps
- **434 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+429 more)
