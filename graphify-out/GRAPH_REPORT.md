...
## Corpus Check
- 107 files · ~164,241 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1142 nodes · 1472 edges · 74 communities (68 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2783e672`
...
Cohesion: 0.09
Nodes (34): DATA, TableDemo(), Checkbox, CheckboxProps, ConfirmarAccion(), ConfirmarAccionProps, SectionHeader(), SectionHeaderProps (+26 more)
...
### Community 7 - "Contexto — Pericia QUITUMBE: adquisición del indicio USB"
Cohesion: 0.05
...
Cohesion: 0.12
Nodes (19): FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, Input, InputProps, MobileNav(), MobileNavItem (+11 more)

### Community 13 - "costura.mjs"
Cohesion: 0.12
Nodes (25): aBarras(), cfg, descubrirLlamadas(), descubrirRutas(), entrada, ENV_SERVICIOS, esDir(), existe() (+17 more)

### Community 14 - "Pendientes del ecosistema SORSABSA"
Cohesion: 0.08
...
### Community 15 - "Plan — Identificación de unidades configurable por condominio"
Cohesion: 0.08
...
Cohesion: 0.10
Nodes (18): CardStatusDemo(), SHADOW, TONES, Card(), CardContent(), CardDescription(), CardHeader(), CardHeaderProps (+10 more)
...
Cohesion: 0.12
Nodes (16): AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials(), SIZE, Button, ButtonProps (+8 more)
...
### Community 26 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.11
...
### Community 27 - "29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md`"
Cohesion: 0.11
...
### Community 28 - "21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026"
Cohesion: 0.12
...
### Community 29 - "ToastProvider.tsx"
Cohesion: 0.17
...
### Community 35 - "Arquitectura del ecosistema SORSABSA"
Cohesion: 0.20
...
### Community 36 - "24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)"
Cohesion: 0.20
...
### Community 44 - "Auditoría del Convertidor — hallazgos de uso real"
Cohesion: 0.29
...
Cohesion: 0.52
Nodes (4): getBrand(), SinAcceso(), salirDelEcosistema(), urlDeSalida()

### Community 47 - "ecosistema.test.ts"
Cohesion: 0.29
Nodes (4): DOC, Entrada, RAIZ, ./src/scripts/ecosistema.mjs

### Community 48 - "3. Mapa de bases de datos — LA TRAMPA"
Cohesion: 0.33
...
### Community 49 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 50 - "27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)"
Cohesion: 0.33
...
### Community 51 - "30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)"
Cohesion: 0.33
...
### Community 59 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
## Knowledge Gaps
- **652 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+647 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `Plan — una persona en más de un condominio (CondoManager)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`?**
