...
## Corpus Check
- 90 files · ~116,127 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 838 nodes · 1113 edges · 53 communities (47 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `929af385`
...
Cohesion: 0.14
Nodes (17): IconCatalog(), NAMES, SHADOW, FormSection(), FormSectionProps, InputProps, MobileNav(), MobileNavItem (+9 more)
...
### Community 23 - "Plan — Identificación de unidades configurable por condominio"
Cohesion: 0.15
...
## Knowledge Gaps
- **462 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+457 more)
