...
## Corpus Check
- 78 files · ~67,908 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 605 nodes · 843 edges · 40 communities (37 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `594c8853`
...
### Community 24 - "Color de marca y contraste"
Cohesion: 0.29
...
## Knowledge Gaps
- **303 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+298 more)
