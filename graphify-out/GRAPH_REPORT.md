...
## Corpus Check
- 91 files · ~121,219 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 868 nodes · 1142 edges · 55 communities (50 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `aa6f52b3`
...
### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (36): App(), BRAND_KEYS, AtomShowcase(), ColorPalette(), TOKEN_ORDER, ContrastReport(), DomusLanding(), FEATURES (+28 more)

### Community 1 - "BrandProvider.tsx"
Cohesion: 0.06
Nodes (39): ButtonMatrix(), SHADOW, VARIANTS, TokenAudit(), TOKENS, BRAND_FONT_IMPORTS, BrandColors, BrandContext (+31 more)
...
### Community 40 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 41 - "9. Pendientes, en orden"
Cohesion: 0.50
...
## Knowledge Gaps
- **485 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+480 more)
