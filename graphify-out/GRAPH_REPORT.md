...
## Corpus Check
- 87 files · ~97,956 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 727 nodes · 1003 edges · 38 communities (35 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `916cb014`
...
1. `Pendientes del ecosistema SORSABSA` - 24 edges
...
Cohesion: 0.05
Nodes (54): MOCK, NotificationDemo(), DATA, AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials() (+46 more)
...
Cohesion: 0.06
Nodes (37): ButtonMatrix(), SHADOW, VARIANTS, TokenAudit(), TOKENS, BRAND_FONT_IMPORTS, BrandColors, BrandContext (+29 more)

### Community 3 - "SinAcceso.tsx"
Cohesion: 0.07
...
## Knowledge Gaps
- **379 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+374 more)
