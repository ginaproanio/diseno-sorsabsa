...
## Corpus Check
- 106 files · ~158,438 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1118 nodes · 1449 edges · 76 communities (70 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61ebb192`
...
### Community 8 - "App.tsx"
Cohesion: 0.09
Nodes (19): App(), BRAND_KEYS, AtomShowcase(), ButtonMatrix(), SHADOW, VARIANTS, FormDemo(), NotImplemented() (+11 more)

### Community 9 - "IconName"
Cohesion: 0.11
Nodes (21): IconCatalog(), NAMES, SHADOW, FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, InputProps (+13 more)

### Community 10 - "Contexto — Pericia QUITUMBE: adquisición del indicio USB"
Cohesion: 0.07
Nodes (28): 1. El caso, 2.1 DESCARTADO: bloqueo de escritura por registro de Windows, 2.2 NO hace falta comprar hardware, 2.3 CAMINO ELEGIDO: live USB forense, 2.4 Lo que sostiene la pericia es la cadena de hashes, 2.5 Reglas de orden — no son opcionales, 2. Decidido y verificado — no volver a discutir, 3.1 El ensayo — se puede hacer hoy, sobre un USB propio (+20 more)
...
### Community 17 - "BrandProvider.tsx"
Cohesion: 0.16
Nodes (17): BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), brandToCssVars(), contrastRatio(), darkenToContrast(), hexToRgb() (+9 more)
...
### Community 22 - "Auditoría — CondoManager como aplicación (más allá del portero)"
Cohesion: 0.09
...
### Community 23 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.10
...
### Community 26 - "BrandConfig"
Cohesion: 0.20
Nodes (13): ColorPalette(), TOKEN_ORDER, ContrastReport(), TypographyDemo(), channelLinear(), contrastRatio(), hexToRgb(), relativeLuminance() (+5 more)

### Community 27 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.11
...
### Community 28 - "29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md`"
Cohesion: 0.11
...
### Community 30 - "Costeo del Convertidor — la prueba de Miraflores"
Cohesion: 0.13
...
### Community 35 - "SinAcceso.tsx"
Cohesion: 0.22
Nodes (9): getBrand(), ButtonProps, ButtonSize, CommonProps, SIZES, VARIANTS, SinAcceso(), salirDelEcosistema() (+1 more)
...
### Community 38 - "Arquitectura del ecosistema SORSABSA"
Cohesion: 0.20
...
### Community 39 - "24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)"
Cohesion: 0.20
...
### Community 43 - "DomusLanding.tsx"
Cohesion: 0.22
Nodes (3): DomusLanding(), FEATURES, SOCIAL

### Community 44 - "4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026"
Cohesion: 0.25
...
### Community 45 - "4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026"
Cohesion: 0.25
...
### Community 46 - "7. Decisión de arquitectura (2026-07-26)"
Cohesion: 0.25
...
### Community 50 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 51 - "27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)"
Cohesion: 0.33
...
### Community 52 - "30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)"
Cohesion: 0.33
...
### Community 53 - "23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito"
Cohesion: 0.40
...
### Community 54 - "28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026"
Cohesion: 0.40
...
### Community 55 - "31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026"
Cohesion: 0.40
...
### Community 59 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 61 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
## Knowledge Gaps
- **632 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+627 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `Plan — una persona en más de un condominio (CondoManager)`, `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`?**
