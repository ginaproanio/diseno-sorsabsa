...
## Corpus Check
- 92 files · ~132,115 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 904 nodes · 1177 edges · 67 communities (64 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `abd9f170`
...
### Community 39 - "3. Mapa de bases de datos — LA TRAMPA"
Cohesion: 0.33
...
### Community 40 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 41 - "27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)"
Cohesion: 0.33
...
## Knowledge Gaps
- **512 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+507 more)
