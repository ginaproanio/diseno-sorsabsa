# Graph Report - diseno-sorsabsa  (2026-08-21)

## Corpus Check
- 90 files · ~115,809 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 836 nodes · 1111 edges · 51 communities (48 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57c85433`
...
9. `Icon` - 12 edges
10. `Arquitectura del ecosistema SORSABSA` - 12 edges
...
Cohesion: 0.04
Nodes (49): 1. Inventario, 2. Los dos planos, 3-bis. NO HAY DATOS DE CLIENTES. Punto., 3. Mapa de bases de datos — LA TRAMPA, 4. Almacenamiento, 4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08), 5. Roturas verificadas el 2026-07-26, 6-bis. Plano de DNS y correo ✅ verificado 2026-07-26 (+41 more)
...
### Community 8 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.05
...
### Community 18 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.12
...
Cohesion: 0.15
Nodes (12): 1 · Qué se probó, 2 · El problema de negocio, en una línea, 3 · Qué se midió, y cómo, 4 · Lo que NO cuesta, 5 · Las opciones de precio, 6 · El detalle que no es de costeo pero salió de la misma prueba, A · Cambiar el modelo de visión, B · Cuota de páginas con visión dentro del plan (+4 more)

### Community 22 - "Plan — Identificación de unidades configurable por condominio"
Cohesion: 0.15
...
### Community 28 - "Plan — Reordenar Configuración/Parametrización de CondoManager"
Cohesion: 0.20
...
### Community 31 - "Auditoría — geo-sorsabsa"
Cohesion: 0.25
...
### Community 32 - "Auditoría — qa_sorsabsa"
Cohesion: 0.25
...
## Knowledge Gaps
- **461 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+456 more)
...
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros`?**
