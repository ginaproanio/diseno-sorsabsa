...
## Corpus Check
- 106 files · ~158,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1120 nodes · 1451 edges · 78 communities (71 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `16b14bec`
...
### Community 1 - "Estándar de desarrollo — no parchear la arquitectura"
Cohesion: 0.05
Nodes (35): 🔵-1 — ✅ CORREGIDO 10-ago-2026 — El propio README del servicio decía que nadie lo consumía, dato desactualizado desde el 08-ago, 🔴-1 — 🟡 CORREGIDO EN CÓDIGO 15-ago-2026, FALTA DESPLEGAR — `/resolver` acepta cualquier URL, sin dominio permitido ni autenticación — SSRF real, sin control de abuso, Auditoría — geo-sorsabsa, 🔵 BAJO, 🔴 CRÍTICO, Pendiente de decidir con Gina antes de ejecutar, Resuelto, verificado, no tocar, 🟠-1 — ✅ CORREGIDO 10-ago-2026 — La tabla de README.md no sumaba porque el conteo de DomusCRM estaba mal (+27 more)
...
### Community 6 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (30): 1. El caso, 2.1 DESCARTADO: bloqueo de escritura por registro de Windows, 2.2 NO hace falta comprar hardware, 2.3 CAMINO ELEGIDO: live USB forense, 2.4 Lo que sostiene la pericia es la cadena de hashes, 2.5 Reglas de orden — no son opcionales, 2. Decidido y verificado — no volver a discutir, 3.1 El ensayo — se puede hacer hoy, sobre un USB propio (+22 more)

### Community 9 - "App.tsx"
Cohesion: 0.10
Nodes (16): App(), BRAND_KEYS, AtomShowcase(), FormDemo(), NotImplemented(), MOCK_PROPERTIES, MockProperty, PropertyCarouselDemo() (+8 more)

### Community 10 - "IconName"
Cohesion: 0.12
Nodes (20): IconCatalog(), NAMES, SHADOW, FormSection(), FormSectionProps, InputProps, MobileNav(), MobileNavItem (+12 more)
...
### Community 14 - "ToastProvider.tsx"
Cohesion: 0.11
Nodes (20): AppShell(), AppShellProps, SIZE, Tag(), TagProps, TONE, Toast(), ToastProps (+12 more)
...
Cohesion: 0.13
Nodes (14): CardStatusDemo(), SHADOW, TONES, Card(), CardContent(), CardDescription(), CardHeader(), CardHeaderProps (+6 more)

### Community 25 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.11
...
### Community 27 - "BrandConfig"
Cohesion: 0.22
Nodes (13): ColorPalette(), TOKEN_ORDER, ContrastReport(), channelLinear(), contrastRatio(), hexToRgb(), relativeLuminance(), rgbTripletToHex() (+5 more)

### Community 28 - "SinAcceso.tsx"
Cohesion: 0.19
Nodes (9): BrandProvider(), base, BRANDS, ESTADOS_FORENSIC, getBrand(), marcaDePrueba, SinAcceso(), salirDelEcosistema() (+1 more)

### Community 29 - "21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026"
Cohesion: 0.12
...
Cohesion: 0.16
Nodes (13): TokenAudit(), TOKENS, useBrand(), WordmarkAnimation, WordmarkTone, FooterEcosistema(), FooterEcosistemaProps, getAnimation() (+5 more)

### Community 31 - "Costeo del Convertidor — la prueba de Miraflores"
Cohesion: 0.13
...
### Community 33 - "4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)"
Cohesion: 0.15
...
### Community 36 - "NotificationBell.tsx"
Cohesion: 0.21
...
### Community 54 - "23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito"
Cohesion: 0.40
...
### Community 55 - "28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026"
Cohesion: 0.40
...
### Community 56 - "31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026"
Cohesion: 0.40
...
### Community 60 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 61 - "9. Pendientes, en orden"
Cohesion: 0.50
...
## Knowledge Gaps
- **634 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+629 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `Plan — una persona en más de un condominio (CondoManager)`, `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`, `Plan — una persona en más de un condominio (CondoManager)`, `4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026`, `4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026`, `7. Decisión de arquitectura (2026-07-26)`, `3. Mapa de bases de datos — LA TRAMPA`, `2. Los dos planos`, `6-bis. Plano de DNS y correo ✅ verificado 2026-07-26`, `9. Pendientes, en orden`?**
