...
## Corpus Check
- 92 files · ~123,907 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 884 nodes · 1157 edges · 58 communities (55 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `968f00c2`
...
1. `Pendientes del ecosistema SORSABSA` - 30 edges
...
### Community 24 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.15
...
### Community 26 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.17
...
### Community 31 - "24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)"
Cohesion: 0.20
...
### Community 37 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 40 - "2 · Método: dónde va cada cosa, y por qué"
Cohesion: 0.40
...
### Community 41 - "23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito"
Cohesion: 0.40
...
## Knowledge Gaps
- **496 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+491 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `PENDIENTES-ECOSISTEMA.md`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `PENDIENTES-ECOSISTEMA.md`, `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`?**
