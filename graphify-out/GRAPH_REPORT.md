...
## Corpus Check
- 80 files · ~72,765 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 627 nodes · 865 edges · 36 communities (33 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `32d7b8cf`
...
### Community 15 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
### Community 17 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.18
...
## Knowledge Gaps
- **316 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+311 more)
