...
## Corpus Check
- 69 files · ~36,275 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 477 nodes · 709 edges · 30 communities (27 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `26accbf8`
...
### Community 3 - "CardStatusDemo.tsx"
Cohesion: 0.08
...
### Community 11 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.15
...
## Knowledge Gaps
- **212 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+207 more)
