...
## Corpus Check
- 86 files · ~95,165 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 722 nodes · 992 edges · 38 communities (35 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d1d6bbd`
...
### Community 7 - "Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)"
Cohesion: 0.05
...
### Community 16 - "Auditoría — agente24siete, el portero (sesión/autenticación)"
Cohesion: 0.14
...
### Community 17 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.15
...
## Knowledge Gaps
- **377 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+372 more)
