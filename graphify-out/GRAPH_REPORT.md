...
## Corpus Check
- 70 files · ~38,799 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 489 nodes · 720 edges · 30 communities (27 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8008137c`
...
### Community 12 - "Estándar de desarrollo — no parchear la arquitectura"
Cohesion: 0.17
...
## Knowledge Gaps
- **222 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+217 more)
