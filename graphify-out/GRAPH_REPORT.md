...
## Corpus Check
- 97 files · ~140,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 953 nodes · 1245 edges · 73 communities (69 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3d6c9f15`
...
1. `Pendientes del ecosistema SORSABSA` - 33 edges
...
### Community 6 - "App.tsx"
Cohesion: 0.09
Nodes (19): App(), BRAND_KEYS, AtomShowcase(), FormDemo(), MOCK, NotificationDemo(), NotImplemented(), MOCK_PROPERTIES (+11 more)

### Community 7 - "IconName"
Cohesion: 0.12
...
### Community 13 - "BrandProvider.tsx"
Cohesion: 0.16
Nodes (16): BRAND_FONT_IMPORTS, BrandColors, BrandConfig, BrandContext, BrandProvider(), contrastRatio(), darkenToContrast(), hexToRgb() (+8 more)

### Community 14 - "AppShell.tsx"
Cohesion: 0.10
Nodes (18): AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials(), SIZE, ButtonProps, ButtonSize (+10 more)
...
### Community 21 - "ContrastReport.tsx"
Cohesion: 0.23
...
### Community 22 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.12
...
### Community 23 - "Costeo del Convertidor — la prueba de Miraflores"
Cohesion: 0.13
...
### Community 24 - "DomusLanding.tsx"
Cohesion: 0.13
Nodes (8): ButtonMatrix(), SHADOW, VARIANTS, DomusLanding(), FEATURES, SOCIAL, Button, ButtonVariant
...
### Community 26 - "4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)"
Cohesion: 0.15
...
### Community 27 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.15
...
### Community 28 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
### Community 29 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.17
...
### Community 31 - "Arquitectura del ecosistema SORSABSA"
Cohesion: 0.18
...
### Community 32 - "Grafo de conocimiento (graphify) generado por CI"
Cohesion: 0.20
...
### Community 33 - "24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)"
Cohesion: 0.20
...
### Community 34 - "conformidad.mjs"
Cohesion: 0.29
Nodes (6): AQUI, ECOSISTEMA, grafoAtrasado(), pedirGitHub(), tokenGitHub(), ultimoCommitDeCodigo()
...
### Community 42 - "modales.mjs"
Cohesion: 0.25
Nodes (3): IGNORAR, PATRONES, raices

### Community 43 - "Color de marca y contraste"
Cohesion: 0.29
Nodes (6): Color de marca y contraste, Componentes que ya lo aplican, Cuál usar, Cómo comprobarlo, La regla, Los cuatro tokens

### Community 44 - "29. 🟡 Lo que queda del barrido de UI del 23-ago-2026 — 18 modales, 8 desvíos y un sistema de avisos sin disparador"
Cohesion: 0.29
Nodes (7): 29.1 · 18 modales del navegador, 29.2 · 8 desvíos de conformidad — de los cuales 1 es falso positivo, 29.3 · El design system tiene `Toast` pero no cómo dispararlo, 29.4 · La deuda que se retira se escribe (regla 6, parte II), 29.5 · Los tres checks afirmaban cosas que no habían mirado (`diseno@68fbdc0`), 29.6 · Cómo correr estas comprobaciones, 29. 🟡 Lo que queda del barrido de UI del 23-ago-2026 — 18 modales, 8 desvíos y un sistema de avisos sin disparador

### Community 45 - "scripts"
Cohesion: 0.29
Nodes (7): scripts, conformidad, conformidad:local, modales, modales:local, test, typecheck
...
### Community 50 - "2 · Método: dónde va cada cosa, y por qué"
Cohesion: 0.40
...
### Community 54 - "8 · Lo que la decisión de "no guardar" NO resuelve"
Cohesion: 0.50
...
### Community 56 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 57 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
## Knowledge Gaps
- **535 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+530 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `29. 🟡 Lo que queda del barrido de UI del 23-ago-2026 — 18 modales, 8 desvíos y un sistema de avisos sin disparador`, `PENDIENTES-ECOSISTEMA.md`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026`, `7. Decisión de arquitectura (2026-07-26)`, `PENDIENTES-ECOSISTEMA.md`, `3. Mapa de bases de datos — LA TRAMPA`, `2. Los dos planos`, `6-bis. Plano de DNS y correo ✅ verificado 2026-07-26`, `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`, `1. Inventario`, `4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)` connect `Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)` to `PENDIENTES-ECOSISTEMA.md`?**
