...
## Corpus Check
- 90 files · ~118,616 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 855 nodes · 1130 edges · 59 communities (56 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f51d482`
...
1. `Pendientes del ecosistema SORSABSA` - 28 edges
...
### Community 25 - "NotificationBell.tsx"
Cohesion: 0.21
...
### Community 31 - "4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026"
Cohesion: 0.25
...
### Community 32 - "7. Decisión de arquitectura (2026-07-26)"
Cohesion: 0.25
...
### Community 33 - "Auditoría — agente24siete, el portero (sesión/autenticación)"
Cohesion: 0.25
Nodes (7): 🟡-1 — ⬜ El `refresh_token` se descarta: la sesión dura 60 minutos y se "renueva" con una vuelta completa por el portero. Encontrado 16-ago-2026, 🔴-1 — ✅ RESUELTO Y VALIDADO EN VIVO 10-ago-2026 — El portero de agente24siete es 100% client-side — sin `middleware.ts`, a diferencia del patrón ya estabilizado en CondoManager, Auditoría — agente24siete, el portero (sesión/autenticación), 🔴 CRÍTICO, 🟡 MEDIO, Pendiente de decidir con Gina antes de ejecutar, Resuelto con Gina (ya no está pendiente)
...
### Community 38 - "3. Mapa de bases de datos — LA TRAMPA"
Cohesion: 0.33
...
### Community 43 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 44 - "9. Pendientes, en orden"
Cohesion: 0.50
...
## Knowledge Gaps
- **477 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+472 more)
...
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `7. Decisión de arquitectura (2026-07-26)`, `3. Mapa de bases de datos — LA TRAMPA`, `Plan — una persona en más de un condominio (CondoManager)`, `2. Los dos planos`, `6-bis. Plano de DNS y correo ✅ verificado 2026-07-26`, `9. Pendientes, en orden`, `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`, `4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026`?**
