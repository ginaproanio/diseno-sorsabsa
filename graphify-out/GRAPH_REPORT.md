...
## Corpus Check
- 106 files · ~159,202 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1124 nodes · 1455 edges · 76 communities (71 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `df0049e3`
...
Cohesion: 0.07
Nodes (36): DomusLanding(), FEATURES, SOCIAL, TokenAudit(), TOKENS, BRAND_FONT_IMPORTS, BrandColors, BrandContext (+28 more)
...
Cohesion: 0.06
Nodes (34): 1. El caso, 2.1 DESCARTADO: bloqueo de escritura por registro de Windows, 2.2 NO hace falta comprar hardware, 2.3 CAMINO ELEGIDO: live USB forense, 2.4 Lo que sostiene la pericia es la cadena de hashes, 2.5 Reglas de orden — no son opcionales, 2. Decidido y verificado — no volver a discutir, 3.1 El ensayo — se puede hacer hoy, sobre un USB propio (+26 more)
...
### Community 45 - "NotificationBell.tsx"
Cohesion: 0.32
...
## Knowledge Gaps
- **637 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+632 more)
