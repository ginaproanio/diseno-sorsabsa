# Graph Report - diseno-sorsabsa  (2026-08-19)

## Corpus Check
- 89 files · ~114,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 823 nodes · 1099 edges · 49 communities (46 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `620d9401`
...
### Community 7 - "DomusLanding.tsx"
Cohesion: 0.08
Nodes (24): DomusLanding(), FEATURES, SOCIAL, IconCatalog(), NAMES, SHADOW, FooterEcosistema(), FooterEcosistemaProps (+16 more)
...
### Community 21 - "CardStatusDemo.tsx"
Cohesion: 0.16
...
### Community 30 - "Auditoría — geo-sorsabsa"
Cohesion: 0.25
...
### Community 31 - "Auditoría — qa_sorsabsa"
Cohesion: 0.25
...
## Knowledge Gaps
- **451 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+446 more)
