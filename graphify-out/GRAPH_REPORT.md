...
## Corpus Check
- 74 files · ~56,054 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 572 nodes · 801 edges · 33 communities (30 shown, 3 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `916e833e`
...
Cohesion: 0.05
Nodes (55): DATA, AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials(), SIZE, ButtonProps (+47 more)

### Community 1 - "App.tsx"
Cohesion: 0.07
Nodes (33): App(), BRAND_KEYS, AtomShowcase(), ButtonMatrix(), SHADOW, VARIANTS, ColorPalette(), TOKEN_ORDER (+25 more)

### Community 2 - "DomusLanding.tsx"
Cohesion: 0.06
Nodes (31): CardStatusDemo(), SHADOW, TONES, DomusLanding(), FEATURES, SOCIAL, IconCatalog(), NAMES (+23 more)
...
## Knowledge Gaps
- **286 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+281 more)
