...
## Summary
- 706 nodes · 952 edges · 45 communities (40 shown, 5 thin omitted)
...
### Community 2 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.04
...
Cohesion: 0.10
Nodes (28): TokenAudit(), TOKENS, BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), brandToCssVars(), contrastRatio() (+20 more)
...
Cohesion: 0.17
Nodes (15): FormSection(), FormSectionProps, InputProps, MobileNav(), MobileNavItem, MobileNavProps, StatusBadge(), StatusBadgeProps (+7 more)
...
### Community 26 - "magnific-upscale.mjs"
Cohesion: 0.36
...
### Community 31 - "SegmentedControl.tsx"
Cohesion: 0.50
...
## Knowledge Gaps
- **369 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+364 more)
