...
## Corpus Check
- 69 files · ~30,909 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 470 nodes · 703 edges · 26 communities (24 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5b423ae`
...
1. `Pendientes del ecosistema SORSABSA` - 14 edges
...
### Community 6 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (19): 10. Login con Google (mejora, no bloquea nada)  🔵 apuntado 08-ago-2026, 1. Separar auth a su propio proyecto  🟠 #1 — INTENTADO 29-jul, chocó un muro real, 2. JustiRed al SSO central  🟡 casi hecho — faltan 3 pasos manuales, 3. ✅ HECHO — cutover de pagos (fuera de Vercel), 4-bis. Limpieza menor en agente24siete, 4. ✅ HECHO — notificaciones-sorsabsa → Railway, 5. RLS en tablas expuestas (seguridad), 6. Borrar proyecto Supabase huérfano (+11 more)
...
## Knowledge Gaps
- **204 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+199 more)
