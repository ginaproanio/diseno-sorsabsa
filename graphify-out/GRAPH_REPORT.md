...
## Corpus Check
- 92 files · ~128,414 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 895 nodes · 1168 edges · 60 communities (55 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a381de52`
...
### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (36): App(), BRAND_KEYS, AtomShowcase(), ButtonMatrix(), SHADOW, VARIANTS, CardStatusDemo(), ColorPalette() (+28 more)
...
Cohesion: 0.10
Nodes (30): DATA, TableDemo(), SectionHeader(), SectionHeaderProps, SegmentedControl(), SegmentedControlProps, SegmentedOption, ALIGN (+22 more)
...
Cohesion: 0.10
Nodes (19): AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials(), SIZE, Button, ButtonProps (+11 more)

### Community 12 - "IconName"
Cohesion: 0.14
Nodes (17): FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, Input, InputProps, MobileNav(), MobileNavItem (+9 more)
...
Cohesion: 0.15
Nodes (12): SHADOW, TONES, Card(), CardContent(), CardHeader(), CardHeaderProps, CardProps, CardTitle() (+4 more)

### Community 21 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.12
...
### Community 24 - "4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)"
Cohesion: 0.15
...
### Community 25 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.15
...
### Community 26 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
### Community 27 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.17
...
### Community 35 - "Color de marca y contraste"
Cohesion: 0.29
...
### Community 38 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 39 - "27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)"
Cohesion: 0.33
...
### Community 41 - "2 · Método: dónde va cada cosa, y por qué"
Cohesion: 0.40
...
### Community 42 - "23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito"
Cohesion: 0.40
...
### Community 45 - "8 · Lo que la decisión de "no guardar" NO resuelve"
Cohesion: 0.50
...
### Community 46 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
## Knowledge Gaps
- **505 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+500 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `PENDIENTES-ECOSISTEMA.md`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`, `PENDIENTES-ECOSISTEMA.md`?**
