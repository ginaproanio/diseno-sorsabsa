...
## Corpus Check
- 70 files · ~44,497 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 508 nodes · 738 edges · 23 communities (21 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bbd250a3`
...
Cohesion: 0.06
Nodes (53): MOCK, NotificationDemo(), DATA, TableDemo(), AppShell(), AppShellProps, Avatar(), AvatarProps (+45 more)
...
Cohesion: 0.11
Nodes (24): BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), contrastRatio(), darkenToContrast(), hexToRgb(), hexToRgbTriplet() (+16 more)
