...
## Corpus Check
- 102 files · ~149,410 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1036 nodes · 1355 edges · 70 communities (64 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29841860`
...
### Community 0 - "App.tsx"
Cohesion: 0.06
Nodes (38): App(), BRAND_KEYS, AtomShowcase(), ButtonMatrix(), SHADOW, VARIANTS, ColorPalette(), TOKEN_ORDER (+30 more)

### Community 1 - "BrandProvider.tsx"
Cohesion: 0.06
Nodes (37): DomusLanding(), FEATURES, SOCIAL, BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), brandToCssVars() (+29 more)
...
Cohesion: 0.13
Nodes (19): IconCatalog(), NAMES, SHADOW, FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, InputProps (+11 more)
...
### Community 21 - "Grafo de conocimiento (graphify) generado por CI"
Cohesion: 0.11
...
### Community 37 - "4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026"
Cohesion: 0.25
...
### Community 38 - "7. Decisión de arquitectura (2026-07-26)"
Cohesion: 0.25
...
### Community 41 - "ecosistema.test.ts"
Cohesion: 0.29
...
### Community 48 - "30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)"
Cohesion: 0.40
...
### Community 51 - "4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026"
Cohesion: 0.50
...
### Community 52 - "9. Pendientes, en orden"
Cohesion: 0.50
Nodes (4): 9. Pendientes, en orden, Abiertos, en orden, Cerrados el 2026-07-30, Reglas que ya no dependen de la memoria

### Community 53 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
### Community 58 - "exports"
Cohesion: 0.67
Nodes (3): exports, ./preset, ./tokens.css

## Knowledge Gaps
- **578 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+573 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `Plan — una persona en más de un condominio (CondoManager)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`?**
