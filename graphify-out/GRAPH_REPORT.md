...
## Corpus Check
- 99 files · ~144,759 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 990 nodes · 1288 edges · 75 communities (70 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12e34889`
...
### Community 10 - "conformidad.mjs"
Cohesion: 0.12
Nodes (13): AQUI, grafoAtrasado(), pedirGitHub(), tokenGitHub(), ultimoCommitDeCodigo(), conSub(), ECOSISTEMA, raicesLocales() (+5 more)

### Community 11 - "BrandProvider.tsx"
Cohesion: 0.16
...
### Community 18 - "Estándar de desarrollo — no parchear la arquitectura"
Cohesion: 0.10
...
### Community 23 - "29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md`"
Cohesion: 0.11
...
### Community 24 - "21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026"
Cohesion: 0.12
...
### Community 26 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.12
...
### Community 27 - "Costeo del Convertidor — la prueba de Miraflores"
Cohesion: 0.13
...
### Community 28 - "Plan de desoldado del ecosistema SORSABSA"
Cohesion: 0.14
...
### Community 33 - "NotificationBell.tsx"
Cohesion: 0.21
...
### Community 43 - "Auditoría — geo-sorsabsa"
Cohesion: 0.25
...
### Community 44 - "Auditoría — qa_sorsabsa"
Cohesion: 0.25
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `ESTANDAR-DESARROLLO.md`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `ESTANDAR-DESARROLLO.md`, `4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026`, `7. Decisión de arquitectura (2026-07-26)`, `3. Mapa de bases de datos — LA TRAMPA`, `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`, `2. Los dos planos`, `4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026`, `9. Pendientes, en orden`, `1. Inventario`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)` connect `Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)` to `ESTANDAR-DESARROLLO.md`?**
