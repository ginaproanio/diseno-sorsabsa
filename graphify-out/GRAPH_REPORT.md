...
## Corpus Check
- 82 files · ~79,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 670 nodes · 908 edges · 45 communities (39 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b62a4f4d`
...
3. `Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)` - 15 edges
...
### Community 0 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.04
Nodes (41): 🔵-1 — ✅ CORREGIDO 10-ago-2026 — El propio README del servicio decía que nadie lo consumía, dato desactualizado desde el 08-ago, 🔴-1 — 🟡 CORREGIDO EN CÓDIGO 15-ago-2026, FALTA DESPLEGAR — `/resolver` acepta cualquier URL, sin dominio permitido ni autenticación — SSRF real, sin control de abuso, Auditoría — geo-sorsabsa, 🔵 BAJO, 🔴 CRÍTICO, Pendiente de decidir con Gina antes de ejecutar, Resuelto, verificado, no tocar, 🟠-1 — ✅ CORREGIDO 10-ago-2026 — La tabla de README.md no sumaba porque el conteo de DomusCRM estaba mal (+33 more)

### Community 1 - "Arquitectura del ecosistema SORSABSA"
Cohesion: 0.04
Nodes (46): 1. Inventario, 2. Los dos planos, 3-bis. NO HAY DATOS DE CLIENTES. Punto., 3. Mapa de bases de datos — LA TRAMPA, 4. Almacenamiento, 4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08), 5. Roturas verificadas el 2026-07-26, 6-bis. Plano de DNS y correo ✅ verificado 2026-07-26 (+38 more)
...
Cohesion: 0.09
Nodes (22): DomusLanding(), FEATURES, SOCIAL, IconCatalog(), NAMES, SHADOW, FormSection(), FormSectionProps (+14 more)

### Community 7 - "🔴 CRÍTICO"
Cohesion: 0.06
Nodes (31): 🔴-10 — ✅ Confirmar cuenta daba "No se pudo instalar la sesión" — RESUELTO 09-ago-2026, completa a 🔴-7, 🔴-11 — 🔧 DomusCRM corregido 10-ago-2026, agente24siete y JustiRed pendientes — El portero está mal implementado en los 4 productos web, y de tres maneras distintas, 🔴-12 — ✅ RESUELTO Y VALIDADO EN VIVO 10-ago-2026 — agente24siete verificaba su sesión contra el proyecto Supabase equivocado — causa real del bucle que 🔴-1/🟠-3 nunca cerraron, 🔴-1 — ✅ Alta de usuarios no gobernada: el pipeline de registro de cada producto no sabe que identity existe — RESUELTO 09-ago-2026, 🟡-1 — ✅ Eliminación manual de cuentas reales vía SQL directo — reconocido, no repetir, 🟠-1 — ✅ Excepción hardcodeada `app === 'iot'` en /auth/complete — RESUELTO 08-ago-2026, 🔵-1 — ⬜ `iot.redirectUrl` es una URL cruda de Railway, no dominio propio, 🔴-2 / 🔴-3 — ✅ Fallback que trata "no configurado" como estado válido, en el motor de cobros — PAGOS_API_KEY rotada y verificada (+23 more)

### Community 8 - "Plan — SorsabsaForensic a la web (herramienta de perito + servicio público)"
Cohesion: 0.07
Nodes (29): 10. Plazo real y calendario, 11. Dominio, 12. Decisiones pendientes, 1. Los dos perfiles y el modelo de negocio, 2. Lo que se reusa del ecosistema (regla dura del tracker), 3. Acceso al contenido de las plataformas — lo único que cambia en `core/`, 4. Fases, 5. Los expedientes (+21 more)

### Community 9 - "index.ts"
Cohesion: 0.14
Nodes (24): DATA, ALIGN, HIDE_CLASSES, hideClass(), ResponsiveBreakpoint, SIZE_CELL_PADDING, SIZE_HEADER_TEXT, Table() (+16 more)
...
### Community 23 - "Auditoría — agente24siete, el portero (sesión/autenticación)"
Cohesion: 0.20
...
### Community 30 - "SegmentedControl.tsx"
Cohesion: 0.50
...
## Knowledge Gaps
- **348 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+343 more)
...
- **Should `Plan — una persona en más de un condominio (CondoManager)` be split into smaller, more focused modules?**
