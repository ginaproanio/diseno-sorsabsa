...
## Corpus Check
- 106 files · ~162,251 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1135 nodes · 1466 edges · 80 communities (75 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d23b598`
...
Cohesion: 0.07
Nodes (31): DomusLanding(), FEATURES, SOCIAL, TokenAudit(), TOKENS, BRAND_FONT_IMPORTS, BrandColors, BrandContext (+23 more)

### Community 2 - "index.ts"
Cohesion: 0.09
Nodes (35): DATA, Checkbox, CheckboxProps, ConfirmarAccion(), ConfirmarAccionProps, SectionHeader(), SectionHeaderProps, SegmentedControl() (+27 more)
...
### Community 9 - "Auditoría — JustiRed (legaltech)"
Cohesion: 0.07
Nodes (30): 10-ago-2026 — Estado real, adónde debe llegar, y los transversales que esta auditoría todavía no cubrió, 15-ago-2026 — Qué se ejecutó, qué falta, 🟠-1 — ✅ Corregido en código 15-ago-2026 (ver `AUDITORIA-PORTERO-SSO.md` 🔴-11), 🔴-1 — ✅ RESUELTO 15-ago-2026 — El panel de Control de Calidad no hace nada: RLS bloquea la tabla para cualquier usuario, la UI lo esconde con un "éxito" falso, 23-ago-2026 — Por qué JustiRed "iba por otro camino": la respuesta, a la tercera vez que Gina lo preguntó, 26-ago-2026 — Las tres puertas que no existían, y el estado medido, 🔴-2 — 🔧 El portero central tiene a JustiRed registrada en un dominio que NO EXISTE: todo login termina en `justired.app` (NXDOMAIN), 🔴-3 — ✅ RESUELTO 15-ago-2026 — La cola de revisión no gateaba nada: toda ley capturada era pública desde el primer segundo, aprobada o no (+22 more)

### Community 10 - "IconName"
Cohesion: 0.12
Nodes (20): IconCatalog(), NAMES, SHADOW, FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, InputProps (+12 more)
...
### Community 13 - "Plan — Identificación de unidades configurable por condominio"
Cohesion: 0.08
...
### Community 14 - "Auditoría del portero — ¿valida por dónde entra?"
Cohesion: 0.08
...
### Community 20 - "Estándar de desarrollo — no parchear la arquitectura"
Cohesion: 0.10
...
### Community 22 - "Grafo de conocimiento (graphify) generado por CI"
Cohesion: 0.11
...
Cohesion: 0.12
Nodes (15): AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials(), SIZE, ButtonProps, ButtonSize (+7 more)

### Community 24 - "29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md`"
Cohesion: 0.11
...
### Community 25 - "21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026"
Cohesion: 0.12
...
### Community 26 - "ToastProvider.tsx"
Cohesion: 0.17
Nodes (14): Toast(), ToastProps, TONE, Aviso, AvisoNuevo, Contexto, ContextoToast, DURACION_POR_TONO (+6 more)

### Community 27 - "Plan — una persona en más de un condominio (CondoManager)"
Cohesion: 0.12
...
### Community 33 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
### Community 34 - "Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros"
Cohesion: 0.17
Nodes (12): 0 · Lo primero, porque cambia el planteo, 1 · Los tres tipos de almacenamiento — la pregunta de Gina, 3 · Cuánto cuesta — las cuentas hechas, 4 · Lo que sí puede doler: el que paga un mes y se va, 5 · Lo que hay que decidir, 6 · Qué hay que construir, en orden, 7 · El riesgo que no es de costo, y es el más grande, Almacenamiento del ecosistema: modelo, costos y cómo lo hacen otros (+4 more)

### Community 35 - "scripts"
Cohesion: 0.18
Nodes (11): scripts, conformidad, conformidad:local, costura, costura:ecosistema, huerfanos, huerfanos:local, modales (+3 more)

### Community 36 - "Arquitectura del ecosistema SORSABSA"
Cohesion: 0.20
...
### Community 37 - "24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)"
Cohesion: 0.20
...
### Community 41 - "4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026"
Cohesion: 0.25
...
### Community 44 - "Auditoría — geo-sorsabsa"
Cohesion: 0.25
...
### Community 45 - "Auditoría — qa_sorsabsa"
Cohesion: 0.25
...
### Community 52 - "25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)"
Cohesion: 0.33
...
### Community 53 - "27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)"
Cohesion: 0.33
...
### Community 54 - "30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)"
Cohesion: 0.33
...
### Community 55 - "2 · Método: dónde va cada cosa, y por qué"
Cohesion: 0.40
Nodes (5): 2 · Método: dónde va cada cosa, y por qué, Cómo quedan los cubos, El borrado a los 5 días se hace solo, El detalle que además destraba el bloqueo de los 50 MB, Railway y R2 no compiten — hacen cosas distintas

### Community 56 - "🟠 IMPORTANTE"
Cohesion: 0.40
...
### Community 57 - "23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito"
Cohesion: 0.40
...
### Community 58 - "28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026"
Cohesion: 0.40
...
### Community 59 - "31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026"
Cohesion: 0.40
...
### Community 61 - "8 · Lo que la decisión de "no guardar" NO resuelve"
Cohesion: 0.50
Nodes (4): 8.1 · "Se descarga y se borra" igual necesita una ventana de descarga, 8.2 · Una conversión pagada hay que recordarla, 8.3 · Con esto, "capacidad de conversión" tiene un costo que sí crece con el uso, 8 · Lo que la decisión de "no guardar" NO resuelve

### Community 62 - "2. Los dos planos"
Cohesion: 0.50
...
### Community 63 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 64 - "9. Pendientes, en orden"
Cohesion: 0.50
Nodes (4): 9. Pendientes, en orden, Abiertos, en orden, Cerrados el 2026-07-30, Reglas que ya no dependen de la memoria

### Community 66 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
### Community 69 - "framer-motion"
Cohesion: 0.67
Nodes (3): framer-motion, framer-motion, framer-motion

## Knowledge Gaps
- **647 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+642 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `PENDIENTES-ECOSISTEMA.md`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Arquitectura del ecosistema SORSABSA` connect `Arquitectura del ecosistema SORSABSA` to `9. Pendientes, en orden`, `4-quater. Mapa de repos y el grafo — ✅ levantado 22-ago-2026`, `4-ter. El cobro y el portero — ✅ verificado en vivo 22-ago-2026`, `7. Decisión de arquitectura (2026-07-26)`, `PENDIENTES-ECOSISTEMA.md`, `3. Mapa de bases de datos — LA TRAMPA`, `4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)`, `2. Los dos planos`, `6-bis. Plano de DNS y correo ✅ verificado 2026-07-26`?**
