...
## Corpus Check
- 71 files · ~40,681 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 510 nodes · 741 edges · 23 communities (21 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `def490a7`
...
Cohesion: 0.05
Nodes (57): MOCK, NotificationDemo(), DATA, AppShell(), AppShellProps, Avatar(), AvatarProps, getInitials() (+49 more)
...
## Knowledge Gaps
- **237 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+232 more)
