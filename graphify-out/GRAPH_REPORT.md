...
## Corpus Check
- 106 files · ~157,340 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1112 nodes · 1443 edges · 79 communities (73 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53d7b21f`
...
### Community 9 - "ToastProvider.tsx"
Cohesion: 0.09
Nodes (22): MOCK, NotificationDemo(), Notificacion, NotificationBell(), NotificationBellProps, TYPE_COLOR, TYPE_ICON, Toast() (+14 more)
...
### Community 12 - "Plan — Identificación de unidades configurable por condominio"
Cohesion: 0.08
...
### Community 15 - "Contexto — Pericia QUITUMBE: adquisición del indicio USB"
Cohesion: 0.09
Nodes (22): 1. El caso, 2.1 DESCARTADO: bloqueo de escritura por registro de Windows, 2.2 NO hace falta comprar hardware, 2.3 CAMINO ELEGIDO: live USB forense, 2.4 Lo que sostiene la pericia es la cadena de hashes, 2.5 Reglas de orden — no son opcionales, 2. Decidido y verificado — no volver a discutir, 3.1 El ensayo — se puede hacer hoy, sobre un USB propio (+14 more)
...
### Community 19 - "BrandProvider.tsx"
Cohesion: 0.17
Nodes (16): BRAND_FONT_IMPORTS, BrandColors, BrandContext, BrandProvider(), brandToCssVars(), contrastRatio(), darkenToContrast(), hexToRgb() (+8 more)
...
### Community 29 - "Costeo del Convertidor — la prueba de Miraflores"
Cohesion: 0.13
...
### Community 31 - "SinAcceso.tsx"
Cohesion: 0.18
Nodes (11): getBrand(), ButtonProps, ButtonSize, ButtonVariant, CommonProps, SIZES, VARIANTS, SinAcceso() (+3 more)

### Community 32 - "DomusLanding.tsx"
Cohesion: 0.14
Nodes (7): ButtonMatrix(), SHADOW, VARIANTS, DomusLanding(), FEATURES, SOCIAL, Button

### Community 33 - "Wordmark.tsx"
Cohesion: 0.20
Nodes (11): TokenAudit(), TOKENS, useBrand(), WordmarkAnimation, WordmarkTone, getAnimation(), TONE_CLASS, TONOS_POR_DEFECTO (+3 more)

### Community 34 - "4-bis. Georreferenciación y R2 — estado real (verificado 2026-08-08)"
Cohesion: 0.15
...
### Community 35 - "Auditoría — DomusCRM, el portero y el alta de cuenta"
Cohesion: 0.15
...
### Community 36 - "@sorsabsa/ui — Sistema de diseño whitelabel de SORSABSA"
Cohesion: 0.15
...
### Community 47 - "Auditoría — geo-sorsabsa"
Cohesion: 0.25
...
### Community 48 - "Auditoría — qa_sorsabsa"
Cohesion: 0.25
...
### Community 56 - "23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito"
Cohesion: 0.40
...
### Community 57 - "28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026"
Cohesion: 0.40
...
### Community 58 - "31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026"
Cohesion: 0.40
...
### Community 61 - "6-bis. Plano de DNS y correo ✅ verificado 2026-07-26"
Cohesion: 0.50
...
### Community 62 - "9. Pendientes, en orden"
Cohesion: 0.50
Nodes (4): 9. Pendientes, en orden, Abiertos, en orden, Cerrados el 2026-07-30, Reglas que ya no dependen de la memoria

### Community 64 - "26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)"
Cohesion: 0.50
...
### Community 67 - "framer-motion"
Cohesion: 0.67
Nodes (3): framer-motion, framer-motion, framer-motion

## Knowledge Gaps
- **627 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+622 more)
...
- **Why does `Pendientes del ecosistema SORSABSA` connect `Pendientes del ecosistema SORSABSA` to `26. 🔴 ¿Puede un usuario comprar y recibir lo que compró? (22-ago-2026)`, `31. 🔵 El "quién soy" está escrito dos veces, y las copias ya divergieron — 23-ago-2026`, `Plan — una persona en más de un condominio (CondoManager)`, `24. 🟡 El cobro del ecosistema quedó vivo — lo que falta después (21/22-ago-2026)`, `25. ✅ La campana es LA MISMA en todos los productos (cerrado 22-ago-2026)`, `27. ✅ agente24siete ya se puede dar de alta — y el agujero que apareció al hacerlo (22-ago-2026)`, `30. 🟡 Las cuatro comprobaciones que sí encuentran cosas — y el grafo, que no (23-ago-2026)`, `23. ⬜ Consola del negocio y CRM de ventas de SORSABSA — anotado 16-ago-2026, aplazado a propósito`, `28. ⬜ PENDIENTE DE GINA — las pruebas en vivo que quedaron del 22-ago-2026`, `29.7 · Autoauditoría de esta tanda contra `ESTANDAR-DESARROLLO.md``, `21-bis. 🟠 Lo que bloquea el cobro del Convertidor — analizado y resuelto a medias, 16-ago-2026`?**
