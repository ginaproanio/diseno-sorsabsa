...
## Corpus Check
- 65 files · ~19,897 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 405 nodes · 637 edges · 22 communities (20 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ebae0476`
...
Cohesion: 0.08
Nodes (37): DATA, TableDemo(), NotificationBell(), NotificationBellProps, TYPE_COLOR, TYPE_ICON, PropertyCarousel(), PropertyCarouselProps (+29 more)
...
### Community 7 - "Arquitectura del ecosistema SORSABSA"
Cohesion: 0.09
Nodes (21): 1. Inventario, 2. Los dos planos, 3. Mapa de bases de datos — LA TRAMPA, 4. Almacenamiento, 5. Roturas verificadas el 2026-07-26, 6. Lo que NO está verificado, 7. Decisión de arquitectura (2026-07-26), ⚠️ Acoplamiento crítico (+13 more)
...
## Knowledge Gaps
- **154 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+149 more)
...
- **Why does `Wordmark()` connect `BrandProvider.tsx` to `App.tsx`, `index.ts`, `DomusLanding.tsx`, `AppShell.tsx`?**
