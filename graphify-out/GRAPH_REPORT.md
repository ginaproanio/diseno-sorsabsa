...
## Corpus Check
- 72 files · ~51,711 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 542 nodes · 773 edges · 37 communities (32 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9efe9d1d`
...
### Community 0 - "App.tsx"
Cohesion: 0.08
Nodes (29): App(), BRAND_KEYS, AtomShowcase(), ColorPalette(), TOKEN_ORDER, ContrastReport(), FormDemo(), MOCK (+21 more)
...
Cohesion: 0.15
Nodes (13): 🔵-1 — ✅ Artefactos compilados (`scratch/dist/**/*.js`) commiteados al repo — RESUELTO 09-ago-2026, 🟠-1 — ✅ Chequeo de rol/autorización reimplementado en al menos 13 rutas, sin fuente única — RESUELTO 09-ago-2026, 🟠-2 — ✅ `resolverPostLogin`: un error de consulta se trata igual que "usuario sin perfiles todavía" — RESUELTO 09-ago-2026, 🔵-2 — ✅ Unidad fantasma auto-creada en cada registro de admin — RESUELTO 09-ago-2026, 🔵-3 — ✅ `codigo_predial` sin garantía de unicidad — RESUELTO 09-ago-2026, 🔴-3 — ✅ `registros_pendientes` y `campanas_masivas` sin GRANT ni RLS — service_role no podía usarlas — RESUELTO 09-ago-2026, Auditoría — CondoManager como aplicación (más allá del portero), 🔴 CRÍTICO (+5 more)
...
### Community 24 - "SegmentedControl.tsx"
Cohesion: 0.50
...
## Knowledge Gaps
- **264 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+259 more)
