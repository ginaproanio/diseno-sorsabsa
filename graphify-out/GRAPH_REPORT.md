...
## Corpus Check
- 106 files · ~159,589 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1126 nodes · 1457 edges · 77 communities (71 shown, 6 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dd237f5b`
...
Cohesion: 0.05
Nodes (36): 1. El caso, 2.1 DESCARTADO: bloqueo de escritura por registro de Windows, 2.2 NO hace falta comprar hardware, 2.3 CAMINO ELEGIDO: live USB forense, 2.4 Lo que sostiene la pericia es la cadena de hashes, 2.5 Reglas de orden — no son opcionales, 2. Decidido y verificado — no volver a discutir, 3.1 El ensayo — se puede hacer hoy, sobre un USB propio (+28 more)
...
### Community 9 - "App.tsx"
Cohesion: 0.10
Nodes (17): App(), BRAND_KEYS, AtomShowcase(), CardStatusDemo(), FormDemo(), IconCatalog(), NAMES, SHADOW (+9 more)

### Community 10 - "IconName"
Cohesion: 0.11
Nodes (22): FooterEcosistema(), FooterEcosistemaProps, FormSection(), FormSectionProps, Input, InputProps, MobileNav(), MobileNavItem (+14 more)
...
### Community 18 - "BrandProvider.tsx"
Cohesion: 0.17
...
### Community 27 - "CardStatusDemo.tsx"
Cohesion: 0.14
Nodes (13): SHADOW, TONES, Card(), CardContent(), CardDescription(), CardHeader(), CardHeaderProps, CardProps (+5 more)
...
### Community 30 - "ToastProvider.tsx"
Cohesion: 0.17
...
## Knowledge Gaps
- **639 isolated node(s):** `name`, `version`, `description`, `license`, `private` (+634 more)
